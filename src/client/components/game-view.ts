...
import { bubbleAssets, rockAssets, seaweedAssets, terrainDirtAssets, terrainSandAssets } from '@client/utils/game-assets';
import { generateLayout } from '@client/utils/layout-generator';
      ...
      <section class="game-shell" aria-label="Game View">
        <div class="game-stage">
          ...
          ${rocks.map(
            (rock) => html`
              <game-rock
                style="left: ${rock.position.x}px; top: ${rock.position.y}px;"
